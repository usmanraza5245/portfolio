export const portfolioData = {
  ...
  skills: [
    ...
    {
      category: "Database",
      items: ["PostgreSQL", "MySQL", "Redis", "Supabase", "Prisma"],
    },
    {
      category: "DevOps & Cloud",
      items: ["AWS EC2", "AWS S3", "Nginx", "Docker", "BullMQ"],
    },
    {
      category: "AI & Tools",
      items: ["OpenAI API", "Groq SDK", "LangChain", "Mapbox", "Sentry"],
    },
    {
      category: "Testing & DX",
      items: ["Jest", "Vitest", "Storybook", "ESLint", "Git"],
    },
  ],
